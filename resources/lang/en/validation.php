...
return [
    ...
    */
    ...
    "alpha_dash_haakjes"   => ":attribute mag alleen letters, nummers, haakjes en strepen bevatten.",
    "alpha_spaces"         => ":attribute mag alleen letters en spaties bevatten.",
    "alpha_underscore"     => ":attribute mag alleen letters en underscores bevatten.",
    "alpha_underscore_space"  => ":attribute mag alleen letters, spaties en underscores bevatten.",
    ...
    "captcha"              => "De captcha tekens komen niet overeen",
    "phone"				   => "Mogelijke telefoon formaten: '09/123.45.67' of '055/12.34.56' of '0477/11.22.33' ",
