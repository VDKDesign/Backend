<html>
<head>
    <title>VDK Design - 503 Error</title>
...
<div class="content-wrapper" style="margin-left: 0;">
    ...
    <section class="content">
        <div class="error-page">
            ...
            <div>
                <h3><i class="fa fa-warning text-yellow"></i> Opgelet! Request time-out.</h3>
            </div>
            <div class="error-content">
                <p>
                    Het duurde te lang voordat de server reageerde, waardoor er een time-out is opgetreden<br/>
