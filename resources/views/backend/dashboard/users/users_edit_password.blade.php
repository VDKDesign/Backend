...
@section('content')
    <div class="form_page_editor">
        ...
        @endif
        {!! Form::open(array('url' => '/backend/user/'.$user->id.'/edit', 'autocomplete' => 'off')) !!}
            ...
            <div class="form-group">
                <label>E-mail</label>
                <input type="email" name="email" class="form-control" value="{{$user->email}}" placeholder="email" @permission(('user-edit')) required @else disabled @endpermission autocomplete="off">
            </div>
