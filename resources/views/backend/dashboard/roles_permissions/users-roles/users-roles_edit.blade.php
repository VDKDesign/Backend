...
@section('title')
    <title>VDK Design | Gebruikersrol wijzigen</title>
@stop
...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{!! URL::to('/') !!}/backend/users-roles/{{$role_id}}/{{$user_id}}/edit">Gebruikersrol wijzigen</a></li>
    </ol>
@stop
...
@section('content')
    <div class="form_page_editor">
        ...
        @endif
        {!! Form::open(array('url' => '/backend/users-roles/'.$role_id.'/'.$user_id.'/edit')) !!}
            <div class="form-group">
                <label>Gebruikers</label>
                {{Form::select('user', $users, $user_id, ['class' => 'form-control select2'])}}
            </div>
            <div class="form-group">
            ...
            <div class="form-group buttons">
                ...
                <button type="submit" class="btn btn-primary pull-right" @permission(('user-roles-edit')) @else disabled @endpermission>Wijzigen</button>
            </div>
        {!! Form::close() !!}
    </div>
@endsection