...
@section('title')
    <title>VDK Design | Toegangsrechten | {{$permissions->display_name}}</title>
@stop
...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{!! URL::to('/') !!}/backend/permissions/{{$permissions->id}}/edit">{{$permissions->display_name}}</a></li>
    </ol>
@stop
...
@section('content')
    <div class="form_page_editor">
        ...
        @endif
        {!! Form::open(array('url' => '/backend/permissions/'.$permissions->id.'/edit')) !!}
            <div class="form-group">
                <label>Functie</label>
                <input type="text" name="function" class="form-control" value="{{$permissions->name}}" placeholder="Functie" disabled>
            </div>
            <div class="form-group">
                <label>Weergave naam</label>
                <input type="text" name="display_name" class="form-control" value="{{$permissions->display_name}}" placeholder="Weergave Naam" @permission(('permissions-edit')) required @else disabled @endpermission>
            </div>
            <div class="form-group">
                <label>Omschrijving</label>
                <input type="text" name="description" class="form-control" value="{{$permissions->description}}" placeholder="Omschrijving" @permission(('permissions-edit')) required @else disabled @endpermission>
            </div>
