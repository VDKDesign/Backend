...
@section('title')
    <title>VDK Design | Aanmaken widget | Niveau 1</title>
@stop
...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{!! URL::to('/') !!}/backend/new_widget">Aanmaken widget | Niveau 1</a></li>
    </ol>
@stop
...
@section('content')
    <div class="form_page_editor">
        ...
        @endif
        {!! Form::open(array('url' => '/backend/new_widget/create')) !!}
            ...
            <div class="form-group">
                ...
                <select class="form-control select2" name="hoofdpagina" style="width: 100%;" >
                    <option value="" selected="selected">-- Kies een pagina (niveau 1) --</option>
            ...
            <div class="form-group buttons">
                ...
                <button type="submit" name="aanmaken" value="aanmaken" class="btn btn-primary pull-right" style="margin-right: 10px;">Aanmaken</button>            </div>
        {!! Form::close() !!}
    </div>
@endsection