...
<head>
    ...
    <title>VDK Design - Nieuwsbrief</title>

    <!-- PLUGIN CSS -->
    {!! Theme::style('css/general/font-awesome/css/font-awesome.min.css') !!}
    ...
    <tr>
        ...
        <td class="header container" >
            ...
            <div class="content">
                <table bgcolor="#222">
                    <tr>
                        <td> <img src="{{ Imagy::getThumbnail('/assets/media/logo-red-white.png', 'largeThumb') }}"  class="" alt="Logo"/></td>
                    </tr>
                </table>
            </div>
                ...
                <table>
                    <tr>
                        <td>
                            <h3>Beste,</h3>
                            <p>
                                Wij hebben uw inschrijving goed ontvangen. Via de nieuwsbrief blijft u op de hoogte van de laatste nieuwtjes. <br/><br/>
                                Gelieve de laatste bevestigingsmail te accepteren.
                            </p>
